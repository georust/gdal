...
/// Configuration options for [`super::DemProcessing::slope`].
...
/// Exposes common DEM routine options to [`SlopeOptions`]
impl DemCommonOptionsOwner for SlopeOptions {
...
mod tests {
    ...
    fn slope() -> Result<()> {
        ...
        let slope = ds.slope(target("dem-hills-slope.tiff"), &opts)?;
