...
/// Configuration options for [`super::DemProcessing::color_relief`].
#[derive(Debug, Clone)]
...
/// Exposes common DEM routine options to [`ColorReliefOptions`]
impl DemCommonOptionsOwner for ColorReliefOptions {
...
mod tests {
    ...
    fn color_relief() -> Result<()> {
        ...
        let cr = ds.color_relief(target("dem-hills-relief.tiff"), &opts)?;
