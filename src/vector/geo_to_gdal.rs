...
impl <T> ToGdal for geo_types::Point<T> where T: Float {
...
impl <T> ToGdal for geo_types::MultiPoint<T> where T: Float {
    fn to_gdal(&self) -> Result<Geometry> {
...
impl <T> ToGdal for geo_types::LineString<T> where T: Float {
    fn to_gdal(&self) -> Result<Geometry> {
        geometry_with_points(OGRwkbGeometryType::wkbLineString, self)
    }
}

impl <T> ToGdal for geo_types::MultiLineString<T> where T: Float {
    fn to_gdal(&self) -> Result<Geometry> {
...
impl <T> ToGdal for geo_types::GeometryCollection<T> where T: Float {
    fn to_gdal(&self) -> Result<Geometry> {
...
impl <T> ToGdal for geo_types::Geometry<T> where T: Float {
    fn to_gdal(&self) -> Result<Geometry> {
        match *self {
