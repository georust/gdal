...
impl GeometryRef {
    ...
    pub fn delaunay_triangulation(&self, tolerance: Option<f64>) -> Result<Geometry> {
        let c_geom = unsafe {
    ...
    pub fn simplify_preserve_topology(&self, tolerance: f64) -> Result<Geometry> {
    ...
    pub fn buffer(&self, distance: f64, n_quad_segs: u32) -> Result<Geometry> {
