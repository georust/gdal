...
extern "C" {
    pub fn GDALLoadRPBFile(
        pszFilename: *const libc::c_char,
        papszSiblingFiles: *mut *mut libc::c_char,
    ) -> *mut *mut libc::c_char;
}
extern "C" {
    pub fn GDALLoadRPCFile(
        pszFilename: *const libc::c_char,
        papszSiblingFiles: *mut *mut libc::c_char,
    ) -> *mut *mut libc::c_char;
}
extern "C" {
    pub fn GDALWriteRPBFile(
        pszFilename: *const libc::c_char,
        papszMD: *mut *mut libc::c_char,
    ) -> CPLErr::Type;
}
extern "C" {
    pub fn GDALLoadIMDFile(
        pszFilename: *const libc::c_char,
        papszSiblingFiles: *mut *mut libc::c_char,
    ) -> *mut *mut libc::c_char;
}
extern "C" {
    pub fn GDALWriteIMDFile(
        pszFilename: *const libc::c_char,
        papszMD: *mut *mut libc::c_char,
    ) -> CPLErr::Type;
}
...
pub union OGRField {
    ...
    pub RealList: OGRField__bindgen_ty_2,
    pub StringList: OGRField__bindgen_ty_3,
    pub Binary: OGRField__bindgen_ty_4,
    pub Set: OGRField__bindgen_ty_5,
...
fn bindgen_test_layout_OGRField__bindgen_ty_4() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OGRField__bindgen_ty_4>())).paData as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(OGRField__bindgen_ty_4),
...
fn bindgen_test_layout_OGRField__bindgen_ty_5() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OGRField__bindgen_ty_5>())).nMarker1 as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OGRField__bindgen_ty_5>())).nMarker2 as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(OGRField__bindgen_ty_5),
...
fn bindgen_test_layout_OGRField__bindgen_ty_6() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OGRField__bindgen_ty_6>())).Year as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OGRField__bindgen_ty_6>())).Month as *const _ as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(OGRField__bindgen_ty_6),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OGRField__bindgen_ty_6>())).Day as *const _ as usize },
        3usize,
        concat!(
            "Offset of field: ",
            stringify!(OGRField__bindgen_ty_6),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OGRField__bindgen_ty_6>())).Hour as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(OGRField__bindgen_ty_6),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OGRField__bindgen_ty_6>())).Minute as *const _ as usize },
        5usize,
        concat!(
            "Offset of field: ",
            stringify!(OGRField__bindgen_ty_6),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OGRField__bindgen_ty_6>())).Second as *const _ as usize },
        6usize,
        concat!(
            "Offset of field: ",
            stringify!(OGRField__bindgen_ty_6),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OGRField__bindgen_ty_6>())).TZFlag as *const _ as usize },
        7usize,
        concat!(
            "Offset of field: ",
            stringify!(OGRField__bindgen_ty_6),
...
extern "C" {
    pub fn OGR_F_GetFID(arg1: OGRFeatureH) -> libc::c_long;
}
extern "C" {
    pub fn OGR_F_SetFID(arg1: OGRFeatureH, arg2: libc::c_long) -> OGRErr::Type;
}
extern "C" {
...
extern "C" {
    pub fn OGR_L_SetNextByIndex(arg1: OGRLayerH, arg2: libc::c_long) -> OGRErr::Type;
}
extern "C" {
    pub fn OGR_L_GetFeature(arg1: OGRLayerH, arg2: libc::c_long) -> OGRFeatureH;
}
extern "C" {
...
extern "C" {
    pub fn OGR_L_DeleteFeature(arg1: OGRLayerH, arg2: libc::c_long) -> OGRErr::Type;
}
extern "C" {
...
extern "C" {
    pub fn OGR_L_GetFeatureCount(arg1: OGRLayerH, arg2: libc::c_int) -> libc::c_int;
}
extern "C" {
