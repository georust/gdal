...
extern "C" {
    pub fn CPLStrnlen(pszStr: *const libc::c_char, nMaxLen: size_t) -> size_t;
}
extern "C" {
    pub fn CPLvsnprintf(
...
extern "C" {
    pub fn OGR_G_WkbSizeEx(hGeom: OGRGeometryH) -> size_t;
}
extern "C" {
...
extern "C" {
    pub fn GDALReleaseArrays(arrays: *mut GDALMDArrayH, nCount: size_t);
}
extern "C" {
