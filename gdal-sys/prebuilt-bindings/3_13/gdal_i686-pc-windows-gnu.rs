...
pub type off32_t = ::std::ffi::c_long;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of stat64"][::std::mem::size_of::<stat64>() - 56usize];
    ["Alignment of stat64"][::std::mem::align_of::<stat64>() - 8usize];
    ["Offset of field: stat64::st_dev"][::std::mem::offset_of!(stat64, st_dev) - 0usize];
    ["Offset of field: stat64::st_ino"][::std::mem::offset_of!(stat64, st_ino) - 4usize];
    ["Offset of field: stat64::st_mode"][::std::mem::offset_of!(stat64, st_mode) - 6usize];
    ["Offset of field: stat64::st_nlink"][::std::mem::offset_of!(stat64, st_nlink) - 8usize];
    ["Offset of field: stat64::st_uid"][::std::mem::offset_of!(stat64, st_uid) - 10usize];
    ["Offset of field: stat64::st_gid"][::std::mem::offset_of!(stat64, st_gid) - 12usize];
    ["Offset of field: stat64::st_rdev"][::std::mem::offset_of!(stat64, st_rdev) - 16usize];
    ["Offset of field: stat64::st_size"][::std::mem::offset_of!(stat64, st_size) - 24usize];
    ["Offset of field: stat64::st_atime"][::std::mem::offset_of!(stat64, st_atime) - 32usize];
    ["Offset of field: stat64::st_mtime"][::std::mem::offset_of!(stat64, st_mtime) - 40usize];
    ["Offset of field: stat64::st_ctime"][::std::mem::offset_of!(stat64, st_ctime) - 48usize];
};
unsafe extern "C" {
...
>;
#[doc = " Has a read error (non end-of-file related) has occurred?\n @since GDAL 3.10"]
pub type VSIFilesystemPluginErrorCallback = ::std::option::Option<
    unsafe extern "C" fn(pFile: *mut ::std::ffi::c_void) -> ::std::ffi::c_int,
>;
#[doc = " Clear error and end-of-file flags.\n @since GDAL 3.10"]
...
const _: () = {
    ...
    ["Offset of field: VSIFilesystemPluginCallbacksStruct::advise_read"]
        [::std::mem::offset_of!(VSIFilesystemPluginCallbacksStruct, advise_read) - 84usize];
    ["Offset of field: VSIFilesystemPluginCallbacksStruct::error"]
        [::std::mem::offset_of!(VSIFilesystemPluginCallbacksStruct, error) - 88usize];
    ["Offset of field: VSIFilesystemPluginCallbacksStruct::clear_err"]
        [::std::mem::offset_of!(VSIFilesystemPluginCallbacksStruct, clear_err) - 92usize];
};
unsafe extern "C" {
...
pub mod CPLLockFileStatus {
    #[doc = " Return code of CPLLockFileEx()."]
    pub type Type = ::std::ffi::c_uint;
    #[doc = "< CPLLockFileEx() succeeded."]
    pub const CLFS_OK: Type = 0;
    #[doc = "< Lock file creation failed."]
    pub const CLFS_CANNOT_CREATE_LOCK: Type = 1;
    #[doc = "< Lock already taken (and still alive)."]
...
#[doc = " Opaque type used for the C bindings of the C++ GDALComputedRasterBand class"]
...
#[doc = " Opaque type for OGRGeomCoordinatePrecision"]
...
#[doc = " Opaque type for a OGR datasource (OGRDataSource) (deprecated)"]
pub type OGRDataSourceH = *mut ::std::ffi::c_void;
#[doc = " Opaque type for a OGR driver (OGRSFDriver) (deprecated)"]
...
pub mod OGRwkbGeometryType {
    ...
    #[doc = "< Curve (abstract type). ISO SQL/MM Part 3."]
    pub const wkbCurve: Type = 13;
    #[doc = "< Surface (abstract type). ISO SQL/MM Part 3."]
    ...
    #[doc = "< a Triangle. ISO SQL/MM Part 3."]
...
pub mod OGRFieldType {
    ...
    pub type Type = ::std::ffi::c_uint;
    #[doc = " Single signed 32bit integer"]
    pub const OFTInteger: Type = 0;
    #[doc = " List of signed 32bit integers"]
    ...
    #[doc = " Single signed 64bit integer"]
    pub const OFTInteger64: Type = 12;
    #[doc = " List of signed 64bit integers"]
...
unsafe extern "C" {
    pub fn OGR_G_ConcaveHullOfPolygons(
        arg1: OGRGeometryH,
        dfLengthRatio: f64,
        bIsTight: bool,
        bAllowHoles: bool,
...
unsafe extern "C" {
    pub fn OGR_G_GetInvalidityReason(arg1: OGRGeometryH) -> *mut ::std::ffi::c_char;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn OGR_G_SetPointCount(
        hGeom: OGRGeometryH,
        nNewPointCount: ::std::ffi::c_int,
    ) -> OGRErr::Type;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn OGR_G_AddPoint(arg1: OGRGeometryH, arg2: f64, arg3: f64, arg4: f64) -> OGRErr::Type;
}
unsafe extern "C" {
    pub fn OGR_G_AddPoint_2D(arg1: OGRGeometryH, arg2: f64, arg3: f64) -> OGRErr::Type;
}
unsafe extern "C" {
    pub fn OGR_G_AddPointM(arg1: OGRGeometryH, arg2: f64, arg3: f64, arg4: f64) -> OGRErr::Type;
}
unsafe extern "C" {
    pub fn OGR_G_AddPointZM(
        arg1: OGRGeometryH,
        arg2: f64,
        arg3: f64,
        arg4: f64,
...
unsafe extern "C" {
    pub fn OGR_G_GetCurveGeometry(hGeom: OGRGeometryH, papszOptions: CSLConstList) -> OGRGeometryH;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn OGR_L_GetAttributeFilter(arg1: OGRLayerH) -> *const ::std::ffi::c_char;
}
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " Clean-up all drivers, including raster ones.\n See GDALDestroyDriverManager()"]
...
pub mod GDALDataType {
    ...
    #[doc = " 8-bit unsigned integer (GDT_Byte in GDAL < 3.13)"]
    pub const GDT_UInt8: Type = 1;
...
const _: () = {
    ...
    ["Offset of field: GDALRasterIOExtraArg::bUseOnlyThisScale"]
        [::std::mem::offset_of!(GDALRasterIOExtraArg, bUseOnlyThisScale) - 56usize];
    ["Offset of field: GDALRasterIOExtraArg::bOperateInBufType"]
        [::std::mem::offset_of!(GDALRasterIOExtraArg, bOperateInBufType) - 60usize];
};
pub mod GDALColorInterp {
    ...
    #[doc = " Red band of RGBA image, or red spectral band [0.62 - 0.69 um]"]
    pub const GCI_RedBand: Type = 3;
    #[doc = " Green band of RGBA image, or green spectral band [0.51 - 0.60 um]"]
    pub const GCI_GreenBand: Type = 4;
    #[doc = " Blue band of RGBA image, or blue spectral band [0.45 - 0.53 um]"]
    ...
    #[doc = " Yellow band of CMYK image, or yellow spectral band [0.58 - 0.62 um]"]
    ...
    #[doc = " Panchromatic band [0.40 - 1.00 um]"]
    pub const GCI_PanBand: Type = 17;
    #[doc = " Coastal band [0.40 - 0.45 um]"]
    pub const GCI_CoastalBand: Type = 18;
    #[doc = " Red-edge band [0.69 - 0.79 um]"]
    pub const GCI_RedEdgeBand: Type = 19;
    #[doc = " Near-InfraRed (NIR) band [0.75 - 1.40 um]"]
    pub const GCI_NIRBand: Type = 20;
    #[doc = " Short-Wavelength InfraRed (SWIR) band [1.40 - 3.00 um]"]
    pub const GCI_SWIRBand: Type = 21;
    #[doc = " Mid-Wavelength InfraRed (MWIR) band [3.00 - 8.00 um]"]
    pub const GCI_MWIRBand: Type = 22;
    #[doc = " Long-Wavelength InfraRed (LWIR) band [8.00 - 15 um]"]
    pub const GCI_LWIRBand: Type = 23;
    #[doc = " Thermal InfraRed (TIR) band (MWIR or LWIR) [3 - 15 um]"]
    pub const GCI_TIRBand: Type = 24;
    #[doc = " Other infrared band [0.75 - 1000 um]"]
    pub const GCI_OtherIRBand: Type = 25;
    #[doc = " Reserved value. Do not set it !"]
    ...
    #[doc = " Synthetic Aperture Radar (SAR) Ka band [0.8 - 1.1 cm / 27 - 40 GHz]"]
    pub const GCI_SAR_Ka_Band: Type = 30;
    #[doc = " Synthetic Aperture Radar (SAR) K band [1.1 - 1.7 cm / 18 - 27 GHz]"]
    pub const GCI_SAR_K_Band: Type = 31;
    #[doc = " Synthetic Aperture Radar (SAR) Ku band [1.7 - 2.4 cm / 12 - 18 GHz]"]
    pub const GCI_SAR_Ku_Band: Type = 32;
    #[doc = " Synthetic Aperture Radar (SAR) X band [2.4 - 3.8 cm / 8 - 12 GHz]"]
    pub const GCI_SAR_X_Band: Type = 33;
    #[doc = " Synthetic Aperture Radar (SAR) C band [3.8 - 7.5 cm / 4 - 8 GHz]"]
    pub const GCI_SAR_C_Band: Type = 34;
    #[doc = " Synthetic Aperture Radar (SAR) S band [7.5 - 15 cm / 2 - 4 GHz]"]
    pub const GCI_SAR_S_Band: Type = 35;
    #[doc = " Synthetic Aperture Radar (SAR) L band [15 - 30 cm / 1 - 2 GHz]"]
    pub const GCI_SAR_L_Band: Type = 36;
    #[doc = " Synthetic Aperture Radar (SAR) P band [30 - 100 cm / 0.3 - 1 GHz]"]
...
unsafe extern "C" {
    pub fn GDALGetColorInterpretationList(
        pnCount: *mut ::std::ffi::c_int,
    ) -> *const GDALColorInterp::Type;
}
...
unsafe extern "C" {
    pub fn GDALGetMetadata(arg1: GDALMajorObjectH, arg2: *const ::std::ffi::c_char)
    -> CSLConstList;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn GDALDatasetGetCloseReportsProgress(hDS: GDALDatasetH) -> bool;
}
unsafe extern "C" {
    pub fn GDALDatasetRunCloseWithoutDestroying(hDS: GDALDatasetH) -> CPLErr::Type;
}
unsafe extern "C" {
    pub fn GDALDatasetRunCloseWithoutDestroyingEx(
        hDS: GDALDatasetH,
        pfnProgress: GDALProgressFunc,
        pProgressData: *mut ::std::ffi::c_void,
    ) -> CPLErr::Type;
...
unsafe extern "C" {
    pub fn GDALDatasetGetInterBandCovarianceMatrix(
        hDS: GDALDatasetH,
        padfCovMatrix: *mut f64,
        nSize: usize,
        nBandCount: ::std::ffi::c_int,
        panBandList: *const ::std::ffi::c_int,
        bApproxOK: bool,
        bForce: bool,
        bWriteIntoMetadata: bool,
        nDeltaDegreeOfFreedom: ::std::ffi::c_int,
        pfnProgress: GDALProgressFunc,
        pProgressData: *mut ::std::ffi::c_void,
    ) -> CPLErr::Type;
}
unsafe extern "C" {
    pub fn GDALDatasetComputeInterBandCovarianceMatrix(
        hDS: GDALDatasetH,
        padfCovMatrix: *mut f64,
        nSize: usize,
        nBandCount: ::std::ffi::c_int,
...
pub mod GDALRasterAlgebraUnaryOperation {
    #[doc = " Raster algebra unary operation"]
    pub type Type = ::std::ffi::c_uint;
    #[doc = " Logical not"]
    pub const GRAUO_LOGICAL_NOT: Type = 0;
    #[doc = " Absolute value (module for complex data type)"]
    pub const GRAUO_ABS: Type = 1;
    #[doc = " Square root"]
    pub const GRAUO_SQRT: Type = 2;
    #[doc = " Natural logarithm (``ln``)"]
...
pub mod GDALRasterAlgebraBinaryOperation {
    #[doc = " Raster algebra binary operation"]
    pub type Type = ::std::ffi::c_uint;
    #[doc = " Addition"]
    ...
    #[doc = " Strictly greater than test"]
    pub const GRABO_GT: Type = 5;
    #[doc = " Greater or equal to test"]
    pub const GRABO_GE: Type = 6;
    #[doc = " Strictly lesser than test"]
    pub const GRABO_LT: Type = 7;
    #[doc = " Lesser or equal to test"]
    pub const GRABO_LE: Type = 8;
    #[doc = " Equality test"]
    pub const GRABO_EQ: Type = 9;
    #[doc = " Non-equality test"]
...
pub mod GDALRATFieldType {
    ...
    #[doc = " Boolean field (GDAL >= 3.12)"]
    pub const GFT_Boolean: Type = 3;
    #[doc = " DateTime field (GDAL >= 3.12)"]
    pub const GFT_DateTime: Type = 4;
    #[doc = " Geometry field, as WKB (GDAL >= 3.12)"]
...
#[doc = " Structure encoding a DateTime field for a GDAL Raster Attribute Table.\n\n @since 3.12"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct GDALRATDateTime {
    ...
    #[doc = " Second [0, 61)"]
    pub fSecond: f32,
    #[doc = " Time zone hour [0, 23]"]
    pub nTimeZoneHour: ::std::ffi::c_int,
    #[doc = " Time zone minute: 0, 15, 30, 45"]
    pub nTimeZoneMinute: ::std::ffi::c_int,
    #[doc = " Whether time zone is positive (or null)"]
    pub bPositiveTimeZone: bool,
    #[doc = " Whether this object is valid"]
    pub bIsValid: bool,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
pub struct GDALMDArrayRawBlockInfo {
    #[doc = " Filename into which the raw block is found"]
    pub pszFilename: *mut ::std::ffi::c_char,
    #[doc = " File offset within pszFilename of the start of the raw block"]
    pub nOffset: u64,
    #[doc = " Size in bytes of the raw block"]
    pub nSize: u64,
    #[doc = " NULL or Null-terminated list of driver specific information on the\n raw block"]
    pub papszInfo: *mut *mut ::std::ffi::c_char,
    #[doc = " In-memory buffer of nSize bytes. When this is set, pszFilename and\n nOffset are set to NULL.\n\n When using C++ copy constructor or copy-assignment operator, if\n a memory allocation fails, a CPLError() will be emitted and this\n field will be NULL, but nSize not zero."]
    pub pabyInlineData: *mut GByte,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of GDALMDArrayRawBlockInfo"][::std::mem::size_of::<GDALMDArrayRawBlockInfo>() - 32usize];
    ...
    ["Offset of field: GDALMDArrayRawBlockInfo::pabyInlineData"]
        [::std::mem::offset_of!(GDALMDArrayRawBlockInfo, pabyInlineData) - 28usize];
};
unsafe extern "C" {
    #[doc = " @endcond"]
...
unsafe extern "C" {
    pub fn GDALMDArrayGetOverviewCount(hArray: GDALMDArrayH) -> ::std::ffi::c_int;
}
unsafe extern "C" {
    pub fn GDALMDArrayGetOverview(hArray: GDALMDArrayH, nIdx: ::std::ffi::c_int) -> GDALMDArrayH;
}
unsafe extern "C" {
    pub fn GDALMDArrayBuildOverviews(
        hArray: GDALMDArrayH,
        pszResampling: *const ::std::ffi::c_char,
        nOverviews: ::std::ffi::c_int,
        panOverviewList: *const ::std::ffi::c_int,
        pfnProgress: GDALProgressFunc,
        pProgressData: *mut ::std::ffi::c_void,
        papszOptions: CSLConstList,
    ) -> CPLErr::Type;
...
pub mod GDALGridAlgorithm {
    ...
    #[doc = " Linear interpolation (from Delaunay triangulation."]
...
pub struct GDALTriangulation {
    ...
    #[doc = "< array of nFacets barycentric coefficients"]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of OSRCRSInfo"][::std::mem::size_of::<OSRCRSInfo>() - 72usize];
    ...
    ["Offset of field: OSRCRSInfo::pszCelestialBodyName"]
        [::std::mem::offset_of!(OSRCRSInfo, pszCelestialBodyName) - 64usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub mod GWKTieStrategy {
    #[doc = " GWKMode tie-breaking strategy"]
    pub type Type = ::std::ffi::c_uint;
...
pub struct GDALWarpOptions {
    ...
    #[doc = " Tie-breaking method"]
    pub eTieStrategy: GWKTieStrategy::Type,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of GDALWarpOptions"][::std::mem::size_of::<GDALWarpOptions>() - 160usize];
    ...
    ["Offset of field: GDALWarpOptions::eTieStrategy"]
        [::std::mem::offset_of!(GDALWarpOptions, eTieStrategy) - 152usize];
};
unsafe extern "C" {
...
#[doc = " Type for a function that returns the pixel data in a provided window"]
...
#[doc = " Opaque type for a VRT dataset"]
pub type VRTDatasetH = *mut ::std::ffi::c_void;
#[doc = " Opaque type for a VRT sourced raster band"]
