...
extern "C" {
    pub fn VSIGetDirectorySeparator(pszPath: *const libc::c_char) -> *const libc::c_char;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct VSIDIR {
...
extern "C" {
    ...
    pub fn VSIRemovePluginHandler(pszPrefix: *const libc::c_char) -> libc::c_int;
}
extern "C" {
    #[doc = " @cond Doxygen_Suppress"]
...
extern "C" {
    pub fn CPLDebugProgress(arg1: *const libc::c_char, arg2: *const libc::c_char, ...);
}
extern "C" {
    #[doc = " @cond Doxygen_Suppress"]
...
extern "C" {
    pub fn CPLStrtodM(arg1: *const libc::c_char, arg2: *mut *mut libc::c_char) -> f64;
}
extern "C" {
...
extern "C" {
    pub fn CPLToupper(c: libc::c_int) -> libc::c_int;
}
extern "C" {
    pub fn CPLTolower(c: libc::c_int) -> libc::c_int;
}
extern "C" {
    pub fn CPLStrlcpy(
...
extern "C" {
    pub fn OGRGeomCoordinatePrecisionGetFormatSpecificOptions(
        arg1: OGRGeomCoordinatePrecisionH,
        pszFormatName: *const libc::c_char,
    ) -> CSLConstList;
}
extern "C" {
...
pub type VRTPDWorkingDataPtr = *mut libc::c_void;
...
pub type GDALVRTProcessedDatasetFuncProcess = ::std::option::Option<
    unsafe extern "C" fn(
        ...
        nBufXSize: libc::c_int,
        nBufYSize: libc::c_int,
        pInBuffer: *const libc::c_void,
        nInBufferSize: usize,
        eInDT: GDALDataType::Type,
        nInBands: libc::c_int,
        padfInNoData: *const f64,
        pOutBuffer: *mut libc::c_void,
        nOutBufferSize: usize,
        eOutDT: GDALDataType::Type,
        nOutBands: libc::c_int,
...
extern "C" {
    pub fn GDALIsLineOfSightVisible(
        ...
        yB: libc::c_int,
        zB: f64,
        pnxTerrainIntersection: *mut libc::c_int,
        pnyTerrainIntersection: *mut libc::c_int,
        papszOptions: CSLConstList,
    ) -> bool;
}
extern "C" {
...
extern "C" {
    pub fn OSRExportToCF1(
        arg1: OGRSpatialReferenceH,
        ppszGridMappingName: *mut *mut libc::c_char,
        ppapszKeyValues: *mut *mut *mut libc::c_char,
        ppszUnits: *mut *mut libc::c_char,
        papszOptions: CSLConstList,
    ) -> OGRErr::Type;
}
extern "C" {
...
extern "C" {
    pub fn OSRIsDerivedProjected(arg1: OGRSpatialReferenceH) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn CPLCreateMutexEx(nOptions: libc::c_int) -> *mut CPLMutex;
}
extern "C" {
    pub fn CPLCreateOrAcquireMutex(arg1: *mut *mut CPLMutex, dfWaitInSeconds: f64) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn CPLAcquireMutex(hMutex: *mut CPLMutex, dfWaitInSeconds: f64) -> libc::c_int;
}
extern "C" {
